...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            decimal pi = System.Convert.ToDecimal(Math.PI);
            decimal X2 = 0;
            decimal totalinertia = 0;

            //Outputs
            decimal y1 = 0, y2 = 0, y3, y4 = 0, y5 = 0, y6 = 0, y7 = 0, y8 = 0, y16 = 0, y17 = 0, y13 = 0, y12 = 0, y11 = 0, y20 = 0, y9 = 0, y10 = 0, y18 = 0, y19 = 0;
            int unit = 0, ch1 = 0, ch2 = 0, vso = 0, pso = 0, tgreq=0;

            //Inputs
            decimal x3 = 0;
            decimal x36 = 0;
            decimal x2 = numericUpDown1.Value;
            decimal x7 = numericUpDown5.Value;
            decimal x9; ///// !MATERIAL!
            decimal x6 = numericUpDown4.Value;
            decimal x5 = numericUpDown3.Value;
            decimal x12 = numericUpDown9.Value;
            decimal x16 = numericUpDown12.Value;
            decimal x13 = numericUpDown10.Value;
            decimal x17 = numericUpDown11.Value;
            decimal x15; ///// !MATERIAL!
            decimal x14 = numericUpDown13.Value;
            decimal x19;///// !MATERIAL!
            decimal x18 = numericUpDown14.Value;
            decimal x24 = numericUpDown16.Value;
            decimal x26 = numericUpDown19.Value;
            decimal x27 = numericUpDown20.Value;
            decimal x34 = numericUpDown27.Value;
            decimal x30 = numericUpDown23.Value;
            decimal x31 = numericUpDown24.Value;
            decimal x33 = numericUpDown26.Value;
            decimal x35 = numericUpDown28.Value;
            decimal x11 = numericUpDown8.Value;
            decimal x20 = numericUpDown15.Value;
            decimal x10 = numericUpDown7.Value;
            decimal x8 = numericUpDown6.Value;
            decimal x25 = numericUpDown17.Value;
            decimal x37 = numericUpDown18.Value;
            decimal x32 = numericUpDown18.Value;
            decimal x28 = numericUpDown21.Value;
            decimal x29 = numericUpDown22.Value;
                ...
                if (error == 0)
            {
                ...
                decimal ratio = tgreq == 1 ? (x16 / x12) : 1;
                ...
                y2 = (Metric.Checked) ? y2 / System.Convert.ToDecimal(Math.Pow(1000, 5)) : y2; //convert x6 and x5 from mm to m
                ...
                if (tgreq == 1)
                {
                    ...
                    {//the user is not sure about the primary pulley gear weight, so we ask for thickness and the material type
                        ...
                        y3 = (Metric.Checked) ? y3 / System.Convert.ToDecimal(Math.Pow(1000, 5)) : y3; //convert x14 &x12 to m.
                    }
                    ...
                    {//the user is not sure about the secondary pulley gear weight, so we ask for thickness and the material type.
                        ...
                        y4 = (Metric.Checked) ? y4 / System.Convert.ToDecimal(Math.Pow(1000, 5)) : y4; //convert x18 & x16 to m.
                    }

                    y5 = (y1 + y2 + y4) * System.Convert.ToDecimal(Math.Pow(System.Convert.ToDouble(x12 / x16), 2)) + y3;
                }
                else
                {
                    y5 = y1 + y2;
                ...
                {//Positioning Operation - Y[6]
                    ...
                    {
                        x33 = x33 != 0 ? x33 : x31 * 0.25m;
                        y6 = ((x30 * ratio) / (x31 - x33)) * (60m / x7);
                    }
                ...
                //Force
                X2 = (Metric.Checked) ? x2 * 9.8m : x2; //for metric x2 (which is mass), is multiplied by gravity(9.8).
                ...
                decimal leadPitch = (Metric.Checked) ? x7 / 1000 : x7; //convert to m for Metric unit.
                y12 = (((y11 * leadPitch) / (2 * pi)) * 1.1m) + x10 * (1 / (x8 * 0.01m)) * (1 / ratio);
